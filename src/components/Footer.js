    ...
    <footer>
      <div className="footer-content">
        <div className="social-media">
          <a href="http://www.linkedin.com/in/catherineyount" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://github.com/Caty1121" target="_blank" rel="noopener noreferrer">
